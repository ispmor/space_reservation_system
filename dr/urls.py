...
urlpatterns = [
    ...
    path(settings.PASSWORD_RESET_URL, auth_views.PasswordResetView.as_view(template_name="modals/password_reset.html", email_template_name="password_reset_email.html"), name='password_reset'),
    ...
    path(settings.REGISTER_URL, views.SignUpView.as_view(), name='signup'),
    path(settings.LOGIN_URL, views.CustomLoginView.as_view(), name='login'),
    path(settings.ABOUT_URL, views.AboutView.as_view(), name='about'),
    path(settings.CONTACT_URL, views.ContactView.as_view(), name='contact'),
